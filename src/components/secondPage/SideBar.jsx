      ...
      <div className="flex flex-col px-2 gap-y-5">
       ...
       <img className="w-[100%] h-[100%]" src={logo} alt="logo" />
        ...
        <div className="flex flex-col text-xs font-medium gap-y-1">
         ...
         <Link to="/events">
        <div className={`flex duration-300  gap-x-5 items-center  cursor-pointer hover:text-[#016ebd] hover:bg-slate-300 px-5 py-2 rounded-xl group ${pathname==="/events" && 'bg-slate-300 text-[#016ebd]' }`}>
        <span>
          <svg
            width="20"
            height="20"
        ...
        <span>Client Avatar</span>
          ...
          <div className={`flex items-center   gap-x-5 cursor-pointer hover:text-[#016ebd] group  hover:bg-slate-300 px-5 py-2 rounded-xl duration-300 ${pathname==="/events/client-pain-points-analysis" && 'bg-slate-300 text-[#016ebd]' }`}>
          <span>
          <svg
          width="20"
          height="20"
        ...
        <Link to="/events/client-dream-outcome">
          ...
          <div className={`flex duration-300 items-center  gap-x-5 cursor-pointer hover:text-[#016ebd] hover:bg-slate-300 px-5 py-2 group rounded-xl ${pathname==="/events/client-dream-outcome" && 'bg-slate-300 text-[#016ebd]' }`}>
            <span>
              <svg
                width="20"
                height="20"
          ...
          <div className={`flex items-center  gap-x-5 cursor-pointer hover:text-[#016ebd] duration-300 hover:bg-slate-300 group px-5 py-2 rounded-xl group ${pathname==="/events/grand-slam-$100M-offers" && 'bg-slate-300 text-[#016ebd]' }`}>
            <span>
              <svg
                width="20"
                height="20"
          ...
          <div className={`flex items-center  gap-x-5 cursor-pointer hover:text-[#016ebd] duration-300 hover:bg-slate-300 group px-5 py-2 rounded-xl ${pathname==="/events/client-pain-point-solutions" && 'bg-slate-300 text-[#016ebd]' }`}>
            <span>
              <svg
                className="group-hover:stroke-[#016ebd] stroke-black"
                width="20"
