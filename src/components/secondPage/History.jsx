...
const History = () => {
  return (
    <div className="flex-none lg:w-[300px] mt-5 px-1 py-1  h-[100vh] overflow-auto rounded-md  overflow-y-scroll no-scrollbar ">
      {/* Heading History */}
      ...
      {historyList.map((elem, ind) => {
        return (
          ...
          >
            ...
            <p className="text-[8px] md:text-sm whitespace-nowrap">Conversation with: Founder</p>
          </div>
        )
      })}
      </div>
